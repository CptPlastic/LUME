...
// Control buttons  
#define BUTTON_AREA_UP     21   // Hardware Pin 33 - SAFE GPIO
#define BUTTON_AREA_DOWN   23   // Hardware Pin 37 - SAFE GPIO
#define BUTTON_RAPID_FIRE  4    // Hardware Pin 26 - Moved here from dangerous fire channel
#define BUTTON_ALL_FIRE    2    // Hardware Pin 24 - Must be LOW during boot, safe for runtime
